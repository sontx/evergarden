...
import { throttleByAnimationFrameDecorator } from "../../utils/throttle-by-animation-frame";
import {
  addObserveTarget,
  getFixedBottom,
  getFixedTop,
...
export class EnhancedAffix extends React.Component<AffixProps, AffixState> {
  state: AffixState = {
